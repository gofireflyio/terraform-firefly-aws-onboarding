...
output "integration_response_status_codes" {
  value = var.stackset ? module.aws-bulk-integrations[0].integration_status_codes : module.firefly_aws_integration[0].integration_status_code
}

output "integration_response_body" {
  value = var.stackset ? module.aws-bulk-integrations[0].integration_response_bodies : module.firefly_aws_integration[0].integration_response_body
}